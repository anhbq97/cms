                  ...
                  <div class="card-body">
                    <form role="form" method="POST" action="/session">
                      ...
                      <div class="text-center">
                        <button type="button" class="btn bg-gradient-info w-100 mt-4 mb-0" @click.prevent="login()">Sign in</button>
                      </div>
                    </form>
                  </div>
              ...
              <div class="col-md-6">
                ...
                >
                  <div
                    ...
                    "
                    style="
                      background-image: url('./storage/images/curved-images/curved6.jpg');
                    "
                  ></div>
                </div>
              </div>
...
export default {
  ...
  methods: {
    login() {
        axios.post('http://cms.poorclu.local/api/v1/auth/login', {
          email: this.email,
