        ...
        >
          ...
          <ul class="navbar-nav justify-content-end">
            ...
            <li class="nav-item d-flex align-items-center">
              <a
                href="javascript:;"
                class="nav-link font-weight-bold px-0 text-body"
              >
                ...
                <li class="mb-2">
                  <a class="dropdown-item border-radius-md" href="javascript:;">
                    <div class="d-flex py-1">
                      <div class="my-auto">
                        <img
                          src="/storage/images/small-logos/logo-spotify.svg"
                    ...
                    <tr>
                      <td>
                        <div class="d-flex px-2">
                          <div>
                            <img
                              src="/storage/images/small-logos/logo-invision.svg"
                              class="avatar avatar-sm rounded-circle me-2"
                              alt="invision"
                            />
                          </div>
                    ...
                    <tr>
                      <td>
                        <div class="d-flex px-2">
                          <div>
                            <img
                              src="/storage/images/small-logos/logo-jira.svg"
                              class="avatar avatar-sm rounded-circle me-2"
                              alt="jira"
                            />
                          </div>
                    ...
                    <tr>
                      <td>
                        <div class="d-flex px-2">
                          <div>
                            <img
                              src="/storage/images/small-logos/logo-slack.svg"
                              class="avatar avatar-sm rounded-circle me-2"
                              alt="slack"
                            />
                          </div>
                    ...
                    <tr>
                      <td>
                        <div class="d-flex px-2">
                          <div>
                            <img
                              src="/storage/images/small-logos/logo-webdev.svg"
                              class="avatar avatar-sm rounded-circle me-2"
                              alt="webdev"
                            />
                          </div>
                    ...
                    <tr>
                      <td>
                        <div class="d-flex px-2">
                          <div>
                            <img
                              src="/storage/images/small-logos/logo-xd.svg"
                              class="avatar avatar-sm rounded-circle me-2"
                              alt="xd"
                            />
                          </div>
...
<script>
import Navigation from "../layouts/backend/Navigation.vue";
